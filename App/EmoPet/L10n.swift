...
enum L10n {
    ...
    private static let table: [PetLanguage: [String: String]] = [
        .chinese: [
            ...
            "settings.language.hint": "切换 App 界面与对话语言",
            "settings.backup.hint": "所有数据保存在本地，可通过 JSON 文件导出/导入。",
        ...
        .english: [
            ...
            "settings.language.hint": "App UI and dialogue language",
            "settings.backup.hint": "All data stays on device. Export or import via JSON.",
        ...
        .japanese: [
            ...
            "settings.language.hint": "アプリと会話の言語",
            "settings.backup.hint": "データは端末内に保存。JSON でエクスポートできます。",
            "module.physiological": "生理",
            "module.interaction": "互动",
            "module.dialogue": "对话",
            "module.assistant": "助手",
